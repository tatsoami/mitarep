 ...
 * @author USER
 */
@WebServlet(name = "Devis", urlPatterns = {"/devis"})
public class Devis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            request.getRequestDispatcher("FormBenefice.jsp").forward(request, response);
            } catch (Exception e) {
                e.printStackTrace();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            V_PrixService v_Service=new V_PrixService();
